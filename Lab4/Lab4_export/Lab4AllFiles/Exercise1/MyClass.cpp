...
{
    // added to delete this.ip and resolve leak
    clear();
...
{
    //This would set ip to a new location on the heap with the given value
//    delete ip;
//    ip = nullptr;
//    ip = new int(newIp);

    //This will set the value stored at the same location to the given value
    *ip = newIp;
}
